...
layui.define(['jquery', 'form', 'upload', 'layer', 'sortable'], function (exports) {
    ...
    class SkuTable {
        options = {
            ...
            SkuTableConfig: {
                thead: [
                    ...
                    {title: '市场价', icon: 'layui-icon-cols'},
                    {title: '售价', icon: 'layui-icon-cols'},
                    {title: '成本价', icon: 'layui-icon-cols'},
                    {title: 'PV值', icon: 'layui-icon-cols'},
                    {title: '库存', icon: 'layui-icon-cols'},
                    {title: '状态', icon: ''},
                ],
                tbody: [
                    {type: 'image', field: 'image', value: '', verify: '', reqtext: ''},
                    {type: 'input', field: 'sku', value: '', verify: 'required', reqtext: 'SKU不能为空'},
                    {type: 'input', field: 'market_price', value: '0', verify: 'required|number', reqtext: '市场价不能为空'},
                    {type: 'input', field: 'sale_price', value: '0', verify: 'required|number', reqtext: '售价不能为空'},
                    {type: 'input', field: 'cost_price', value: '0', verify: 'required|number', reqtext: '成本价不能为空'},
                    {type: 'input', field: 'pv_data', value: '0', verify: 'required|number', reqtext: 'PV值不能为空'},
        ...
        listen() {
             ...
             * 监听所选规格值的变化
             */
            //$("#fairy-spec-filter").on("change",function(data){
